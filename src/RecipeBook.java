...
public class RecipeBook
{
    ...
    public void loadDefaultRecipes()
    {
        ...
        addRecipe(new Recipe("Scrambled Eggs", scrambledEggIngredients));
        ...
        addRecipe(new Recipe("Pancakes", pancakeIngredients));
        ...
        addRecipe(new Recipe("Grilled Cheese", grilledCheeseIngredients));
        ...
        addRecipe(new Recipe("Pasta with Tomato Sauce", pastaIngredients));

        // Peanut Butter and Jelly
        ArrayList<Ingredient> pbjIngredients = new ArrayList<Ingredient>();
        ...
        addRecipe(new Recipe("Peanut Butter and Jelly", pbjIngredients));
    }
}
